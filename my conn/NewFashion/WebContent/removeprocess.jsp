...
<h1><center><u><i>Remove Your Stock</i></u></center></h1></p>
...
<td><a href="removefinal.jsp?billno=<%=resultSet.getString("billno") %>"><button type="button" class="update">Remove</button></a></td>
</tr>
<%
i++;
}%>
